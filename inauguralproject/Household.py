...
class HouseholdSpecializationModelClass:
    ...
    def calc_utility(self,LM,HM,LF,HF):
        ...
        # d. i  defining dummy for whether model is extended in Question 5. If gender==1 then the model is the one defined in Q5
        if par.gender==1:
    ...
    def solve(self):
        ...
        # b. objective function: negative since we minimize
    ...
    def solve_wF_vec(self,discrete=False):
        ...
        sol= self.sol
        opt = self.opt
        # b. solving model for both discrete and continous.
    ...
    def estimate(self,alpha=None,sigma=None):
        ...
        # b. Different initial guesses for our models
        if par.gender==1:
            init=[0.5, 0.1, 0.9]
